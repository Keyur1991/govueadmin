...
export default {
    ...
    methods: {
        ...
        getSettings() {
            ...
            this.$axios.get(this.$URLs.PRODUCTS_IMPORT_SETTINGS)
                .then((response) => {
        ...
        save() {
            ...
            return this.$axios.post(this.$URLs.PRODUCTS_IMPORT_SETTINGS, options)
                .then((response) => {
                    this.$store.dispatch("showProgress", false)
        ...
        downloadSample() {
            let url = '/storage/products_import.' + this.ImportFileFormat.toLowerCase();
        ...
        importData() {
            ...
            this.$axios.post(this.$URLs.PRODUCTS_IMPORT, data)
                .then((response) => {
                    this.$store.dispatch('showProgress', false);
                }).catch((e) => {
                    this.$store.dispatch('showProgress', false);
